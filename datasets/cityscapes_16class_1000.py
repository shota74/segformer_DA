...
class cityscapesDataset(Dataset):
    def __init__(
        ...
        if self.stage == 'train':
            with open(os.path.join(os.path.join(root_dir, self.stage + '_1000.txt')), "r") as f:
    ...
    def __getitem__(self, idx):
        ...
        # img_name = os.path.join(self.img_dir, _img_name.split(os.sep)[-2],
        #                         os.path.basename(_img_name)+ '.png')
        ...
        if self.stage == "train":
            ...
            # label_dir = os.path.join(self.label_dir,_img_name.split(os.sep)[-2],
            #                                      os.path.basename(_img_name)[:-11]+'gtFine_labelTrainIds.png')
